...
class DApp {
    ...
    constructor(config, blockchain) {
        ...
        this.events = {
            get eventsModel() {
                return that.ecmaContract.events.eventsModel;
            },
            get nftModel() {
                return that.ecmaContract.events.NftModel;
            },
            get blockModel() {
                return that.ecmaContract.events.blockModel;
            }
        }
        ...
        this.blocks = {
            ...
            get lastBlockIndex() {
                return that.blockchain.getMaxBlock();
            }
        };
